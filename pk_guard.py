...
from booking_helper import _find_local_driver, _detect_chrome_version, find_book_buttons, button_row_text, normalize_text
    ...
    while True:
        ...
        try:
            ...
            if btn:
                ...
                write_state({"available": False, "time": now, "hint": hint.strip()})
